...
import { FiBell, FiMoon, FiUser, FiLogOut, FiLock, FiSun, FiMonitor, FiSave, FiShield } from "react-icons/fi";
...
export default function Settings() {
  ...
  const checkboxClass = "h-4 w-4 rounded accent-indigo-600";
    ...
    <GlobalLayout>
      <div className="mx-auto w-full max-w-6xl space-y-6">
        <div className="rounded-3xl border border-slate-200 bg-gradient-to-r from-white via-slate-50 to-indigo-50 p-5 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-wide text-indigo-600">Settings</p>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Preferences and Security</h1>
          <p className="mt-1 text-slate-600 text-base">Manage account details, learning preferences, and appearance.</p>
        </div>

        <div className="grid gap-5 grid-cols-1 lg:grid-cols-2 items-start">
          <div className="rounded-2xl bg-white shadow-sm p-5 border border-slate-200 space-y-5">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-3">
              ...
              <span className="font-semibold text-slate-700">Update Email</span>
              <form className="space-y-3" onSubmit={handleEmail}>
                <label className="text-sm font-medium text-slate-700 block">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2.5 bg-white focus:ring-2 focus:ring-indigo-200 focus:border-indigo-300 transition"
                  />
                </label>
                <button
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 text-white font-semibold shadow-sm hover:bg-indigo-700 disabled:opacity-60"
                  type="submit"
                  disabled={busy.email}
                >
                  <FiUser className="text-[18px]" />
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-3">
              ...
              <form className="space-y-3" onSubmit={handlePassword}>
                ...
                <button
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 text-white font-semibold shadow-sm hover:bg-slate-800 disabled:opacity-60"
                  type="submit"
          ...
          <div className="rounded-2xl bg-white shadow-sm p-5 border border-slate-200 space-y-5">
            ...
            <label className="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
              <span className="text-sm text-slate-700 font-medium">Focus reminders</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
              <span className="text-sm text-slate-700 font-medium">Session completion alerts</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
              <span className="text-sm text-slate-700 font-medium">Email digest</span>
              <input
                type="checkbox"
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 text-white font-semibold hover:bg-indigo-700 disabled:opacity-60"
                disabled={busy.prefs}
              >
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-rose-600 text-white font-semibold shadow-sm hover:bg-rose-700 disabled:opacity-60"
